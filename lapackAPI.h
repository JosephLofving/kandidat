...
public:
	...
	LapackMat(int x, int y, std::vector<double> z); // Default constructor
	...
	double getElement(int row, int col); // Returns the element at given indices
	void setElement(int row, int col, double value); // Sets the element at given indices
